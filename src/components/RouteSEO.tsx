...
const map: Record<string, Entry> = {
  ...
  "/university/opensource": { title: "Open Source at Anoneurx University", description: "Earn credit by contributing to real Anoneurx repositories — maintainer mentorship, review practice and release management.", keywords: "anoneurx university open source, contribute, credit, mentorship, repositories" },
  "/university/blackwall": { title: "Black Wall OS at Anoneurx University", description: "Secure systems education on Black Wall OS — kernels, hardening, forensics and adversarial lab exercises.", keywords: "anoneurx university blackwall, secure systems, kernel, hardening, forensics, education" },
  "/university/pay": { title: "Anoneurx Pay at Anoneurx University", description: "Fintech engineering at Anoneurx University — ledgers, payment rails, fraud analytics and compliance.", keywords: "anoneurx university pay, fintech, ledgers, payment rails, fraud, compliance, education" },
  "/university/cloud": { title: "Anoneurx Cloud at Anoneurx University", description: "Cloud and platform engineering at Anoneurx University — infrastructure, SRE practice and live console labs.", keywords: "anoneurx university cloud, platform engineering, infrastructure, sre, labs, education" },
